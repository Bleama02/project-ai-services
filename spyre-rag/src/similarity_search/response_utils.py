...
class SimilaritySearchResponse(BaseModel):
    ...
    results: list[SimilaritySearchResult] = Field(..., description="List of search results with scores")
    score_type: str = Field(..., description="'cosine' or 'relevance'")
    perf_metrics: dict = Field(..., description="Performance metrics for the search operation")
